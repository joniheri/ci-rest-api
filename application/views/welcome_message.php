...
<body>
    ...
    <div id="container">
        ...
        <div id="body">
            ...
            <?php if (file_exists(FCPATH . 'codeigniter-restserver/documentation/index.html')) : ?>
                <h2><a href="<?php echo base_url('codeigniter-restserver/documentation/index.html'); ?>" target="_blank">REST Server Documentation</a></h2>
            <?php endif ?>
